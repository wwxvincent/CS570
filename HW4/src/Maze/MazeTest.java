...
//       }
        ...
        //Test problem 2 find all pth;
        ArrayList<ArrayList<PairInt>> paths = new ArrayList<>();
        paths=m.findAllMazePaths(0, 0);
        for(int i=0;i<paths.size();i++) {
        	System.out.println("The number "+i+"Path is "+paths.get(i));
        }
        
//        //test problem 3 find min path;
//        System.out.println();
//        ArrayList<PairInt> minPath = m.findMazePathMin(0, 0);
//        System.out.println("The min path is "+" "+minPath);
//        
